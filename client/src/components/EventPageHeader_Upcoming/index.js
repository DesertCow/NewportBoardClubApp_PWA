...
function EventPageHeaderUpcoming() {
  ...
  return (
    ...
    <div className="">
      ...
      <div className="eventsTabBox_Upcoming">
         {/* <div className="d-flex align-items-center justify-content-center col px-5 py-3"> */}
         <div className="d-flex flex-col px-0 py-1 my-3 align-items-center justify-content-center">
...
export default EventPageHeaderUpcoming;