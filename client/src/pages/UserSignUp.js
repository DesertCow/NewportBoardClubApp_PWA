      ...
      <div className="flex-column d-flex align-items-center justify-content-center">
        ...
        <div className="registerBox mt-2 mb-5 d-flex flex-column align-items-center justify-content-center">
          ...
          <div className="text-center d-flex flex-column align-items-center justify-content-center">
            <button
              className="startbtns mt-4 mb-4 d-flex flex-column align-items-center justify-content-center"
              type="button"
          ...
          <button className="startbtns mb-4 d-flex flex-column align-items-center justify-content-center" type="button" onClick={(event) => returnHome(event)}>Login</button>
      </div>
